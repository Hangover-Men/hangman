export function getRandomWord()
{
    ...
    * */
    request.open('GET', 'https://random-word-api.herokuapp.com/word?lang=de&number=1');
    request.onload = function() {
        ...
        if (request.status === 200) {
            ...
            console.log("Error "+ request.status +" = "+ request.statusText +"while fetching " + request.responseURL);
